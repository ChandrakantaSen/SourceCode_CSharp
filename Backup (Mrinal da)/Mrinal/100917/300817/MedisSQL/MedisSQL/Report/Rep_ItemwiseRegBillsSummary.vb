...
Imports System
Imports utility
Public Class Rep_ItemwiseRegBillsSummary
    ...
    Private Sub fetchitemdata()
        Try
            ...
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("Rep_ItemwiseRegBillsSummary", Class1.CustomCommandType.StoredPorcedure, param)
    ...
    Private Sub regbilldetails()
        Try
            ...
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("Rep_ItemwiseRegBillsdetails_itemwise", Class1.CustomCommandType.StoredPorcedure, param)
