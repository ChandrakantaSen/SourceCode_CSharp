...
Imports System
Imports utility
Public Class Rep_CategorywisePathDirBillsSummary
    ...
    Private Sub fetchitemdata()
        Try
            ...
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("Rep_CategorywiseDirSalesBillsSummary", Class1.CustomCommandType.StoredPorcedure, param)
