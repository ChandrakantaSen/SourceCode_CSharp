...
Imports System
Imports utility
Public Class Rep_ItemwisePathBillsSummary
    ...
    Private Sub fetchitemdata()
        Try
            ...
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("Rep_ItemwisePathBillsSummary", Class1.CustomCommandType.StoredPorcedure, param)
    ...
    Private Sub dgitemsummary_CellContentClick(sender As Object, e As DataGridViewCellEventArgs)
    ...
    Private Sub regbilldetails()
        Try
            ...
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("Rep_ItemwisePathBillsdetails_itemwise", Class1.CustomCommandType.StoredPorcedure, param)
