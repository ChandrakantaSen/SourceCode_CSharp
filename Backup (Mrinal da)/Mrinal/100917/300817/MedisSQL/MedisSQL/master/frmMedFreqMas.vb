...
Public Class frmMedFreqMas
    ...
    Private Sub populatedosage()
        Try
            ...
            dsd = Class1.ExecQueryDS("MedFreqMas", Class1.CustomCommandType.StoredPorcedure)
            lstGenMas.DataSource = dsd.Tables(0)
            lstGenMas.DisplayMember = "Frequency"
            lstGenMas.ValueMember = "Freqid"
