...
Public Class NCDasDirectBill
        ...
        Try
            ...
            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
                    ...
                    ddcollby.DataSource = ds.Tables(0)
                    ddcollby.DisplayMember = "AgntName"
                    ddcollby.ValueMember = "id"
    ...
    End Sub
    Private Sub getAllunknowndoctorcollectionby()
        Try
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("getAllAgentmaster", Class1.CustomCommandType.StoredPorcedure, Nothing)
            If Not ds Is Nothing Then
        ...
        Try
            ...
            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
                    ...
                    ds.Tables(0).Rows.InsertAt(dr, 0)
                    Me.senttolab.DataSource = ds.Tables(0)
                    Me.senttolab.DisplayMember = "TLabNam"
                    Me.senttolab.ValueMember = "testLabId"
                End If
            End If
    ...
    Private Sub txtlabid_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtlabid.LostFocus
        ...
        End Try
    End Sub
    Private Sub fetchdirectsalesbill()
        Try
            Dim param(0) As SqlParameter
            param(0) = New SqlParameter("@billid", Class1.cdirectsalesbillid)
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("fetchdirectsalesbill", Class1.CustomCommandType.StoredPorcedure, param)
            ...
            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
                    ...
                    txtbillno.Text = ds.Tables(0).Rows(0).Item("PDblId")
                    dtbilldate.Value = ds.Tables(0).Rows(0).Item("PDblDt")
                    ...
                    txtnetamount.Text = ds.Tables(0).Rows(0).Item("PDtotAmt")
                    txtdiscmanagement.Text = ds.Tables(0).Rows(0).Item("PDtotDisc")
                    txtdiscrefdoctor.Text = ds.Tables(0).Rows(0).Item("PDtotDiscRef")
                    txtdiscvisiteddoctor.Text = ds.Tables(0).Rows(0).Item("PDTotDiscVisit")
    ...
    Private Sub editcombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If dgitems.CurrentCell.ColumnIndex <> 0 Then Exit Sub
            ...
            If cbocell.SelectedIndex > 0 Then
                ...
                param(2) = New SqlParameter("reflabfk", reflabid)
                Dim ds As DataSet
                ds = Class1.ExecQueryDS("fetchallergyitemdetailsver3", Class1.CustomCommandType.StoredPorcedure, param)
                If Not ds Is Nothing Then
                    If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
    ...
    Private Sub btnsave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsave.Click
        Try
            ...
            AllergyBillHeader.Columns.Add("collby")
            AllergyBillHeader.Columns.Add("CollByfk")
            AllergyBillHeader.Columns.Add("labdoctor")
            AllergyBillHeader.Columns.Add("labdoctorcode")
            ...
            drheader("collby") = ddcollby.SelectedText
            drheader("CollByfk") = ddcollby.SelectedValue
            drheader("labdoctor") = txtlabdoctor.Text
            drheader("labdoctorcode") = txtlabdoctorcode.Text
            ...
            dtbillsub.Columns.Add("senttolab")
            ...
            For i = 0 To dgitems.Rows.Count - 1
                ...
                drsubbill("senttolab") = dgrow.Cells("senttolab").Value
            ...
            dsret = Class1.ExecQueryDS("sp_Insert_pathdirbill", Class1.CustomCommandType.StoredPorcedure, param)
