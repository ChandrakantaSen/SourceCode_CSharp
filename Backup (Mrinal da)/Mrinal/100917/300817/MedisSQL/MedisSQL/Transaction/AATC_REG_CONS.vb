...
Public Class AATC_REG_CONS
    ...
    Private Sub FetchConsultation()
        Try
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("FetchConsultation", Class1.CustomCommandType.StoredPorcedure, Nothing)
    ...
    Private Sub txtpatientID_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtpatientID.DoubleClick
        Try
            ...
            frmsearchpatient.Height = 750
            frmsearchpatient.Width = 1000
    ...
    Private Sub editcombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If cbocell.SelectedIndex > 0 Then
                ...
                Dim ds As DataSet
                ds = Class1.ExecQueryDS("fetchallergyitemdetails", Class1.CustomCommandType.StoredPorcedure, param)
                If Not ds Is Nothing Then
                    If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
    ...
    End Sub
    Private Sub fetchconssalesbill()
        Try
            Dim param(0) As SqlParameter
            param(0) = New SqlParameter("@billid", Class1.cconsbillid)
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("fetchConsultationbill", Class1.CustomCommandType.StoredPorcedure, param)

            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
                    dtbilldate.Value = ds.Tables(0).Rows(0).Item("AblDt")
                    txtpatientname.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("PtName"))
                    txtvisiteddoctorname.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("VisitToNam"))
                    visiteddoctorid = Class1.SetNegativeOneIfNull(ds.Tables(0).Rows(0).Item("visitingdoctorfk"))
                    txtvisiteddoctorid.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("VisitToId"))
                    txtrefdoctorname.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("RefName"))
                    refdoctorid = Class1.SetNegativeOneIfNull(ds.Tables(0).Rows(0).Item("refdoctorfk"))
                    txtrefdoctorid.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("RefId"))
                    txtlabname.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("LabName"))
                    reflabid = Class1.SetNegativeOneIfNull(ds.Tables(0).Rows(0).Item("labfk"))
                    txtlabid.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("LabId"))
                    ddagent.SelectedValue = Class1.SetNegativeOneIfNull(ds.Tables(0).Rows(0).Item("agentfk"))
                    'ddbillfor.SelectedValue = -1
                    txtbillno.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("AblId"))
                    txtage.Text = Class1.SetZeroIfNull(ds.Tables(0).Rows(0).Item("AgeYr"))
                    txtgrossamount.Text = Class1.SetZeroIfNull(ds.Tables(0).Rows(0).Item("AtotAmt"))
                    txtnetamount.Text = Class1.SetZeroIfNull(ds.Tables(0).Rows(0).Item("AtotBal"))
                    txtdiscmanagement.Text = Class1.SetZeroIfNull(ds.Tables(0).Rows(0).Item("AtotDisc"))
                    txtdiscrefdoctor.Text = Class1.SetZeroIfNull(ds.Tables(0).Rows(0).Item("AtotDiscRef"))
                    txtdiscvisiteddoctor.Text = Class1.SetZeroIfNull(ds.Tables(0).Rows(0).Item("ATotDiscVisit"))
                    txtremarks.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("Remarks"))
                    chkprintremarks.Checked = False
                    billheaderid = Class1.SetNegativeOneIfNull(ds.Tables(0).Rows(0).Item("id"))
                    dtproposeddate.Value = ds.Tables(0).Rows(0).Item("PDelivDt")
                    'txtchno.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("AblId"))
                    'txtpaidamount.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("AblId"))
                    'txtpmtremarks.Text = Class1.SetBlankIfNull(ds.Tables(0).Rows(0).Item("AblId"))
                    txtbilltime.Text = Format(ds.Tables(0).Rows(0).Item("BillTime"), "hh:mm:ss tt")
                    txtbooktime.Text = Format(ds.Tables(0).Rows(0).Item("BokTime"), "hh:mm:ss tt")
                    ...
                    If ds.Tables.Count > 2 And ds.Tables(2).Rows.Count > 0 Then
                        dtpmt.Value = ds.Tables(2).Rows(0).Item("APmtDt")
                        txtpaidamount.Text = ds.Tables(2).Rows(0).Item("APmtAmt")
    ...
    Private Sub showlastbill()
        Try

            Dim param(0) As SqlParameter
            param(0) = New SqlParameter("patientfk", patientfk)
            Dim ds As DataSet
            ds = Class1.ExecQueryDS("showlastregistartionbill", Class1.CustomCommandType.StoredPorcedure, param)
            If Not ds Is Nothing Then
                If ds.Tables.Count > 0 And ds.Tables(0).Rows.Count > 0 Then
                    ...
                    For i = 0 To ds.Tables(1).Rows.Count - 1
                        ...
                        dgrow.Cells("Itemdescription").Value = ds.Tables(1).Rows(i).Item("Itemdescription")
                    Next
                    'dgitems.Columns.Remove("Deliv")
                    'dgitems.Columns.Remove("DelivfromLab")
    ...
    Private Sub btnsave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsave.Click
        Try
            ...
            Dim AblId As String = ""
            AblId = Class1.NewYearId("T_AllergyBill", "AblId", "", Format(dtbilldate.Value, "dd-MMM-yyyy"), 5)
            'Exit Sub
            ...
            drheader("DelivTime") = ""
            drheader("AtotAmt") = IIf(txtnetamount.Text = "", 0, txtnetamount.Text) ' IIf(txtgrossamount.Text = "", 0, txtgrossamount.Text)
            ...
            dsret = Class1.ExecQueryDS("sp_Insert_regbill", Class1.CustomCommandType.StoredPorcedure, param)
    ...
    Private Sub btnprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnprint.Click
        Try
            ...
            Class1.paramarraycrystal.Add(billheaderid)
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs)
        Dim f As New frmPtData
        f.Show()

    End Sub

    Private Sub btnedit_ClientSizeChanged(sender As Object, e As EventArgs) Handles btnedit.ClientSizeChanged
