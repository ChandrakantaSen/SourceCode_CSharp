...
namespace WindowsFormsApplication9.masterDataSet1TableAdapters {
...
SELECT ID, Name, [Sales Price], [Purchase Price], Barcode, Vendor, [Date and Time], Quantity FROM ITEMS WHERE (ID = @ID)";
        ...
        public virtual int Fill(masterDataSet1.ITEMSDataTable dataTable) {
        ...
        public virtual masterDataSet1.ITEMSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet1.ITEMSDataTable dataTable = new masterDataSet1.ITEMSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet1.ITEMSDataTable dataTable) {
