...
namespace Aplicatie
{
	...
	public class Produse : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Denumire = new System.Windows.Forms.ColumnHeader();
			this.Cantitate = new System.Windows.Forms.ColumnHeader();
			this.Um = new System.Windows.Forms.ColumnHeader();
			...
			this.label1.Text = "Cautare materiale";
			// 
			// checkBox1
			// 
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			...
			if (connection!=null && connection.State == ConnectionState.Open)
			{
				...
				if (!este)
				{
					...
					{
						ListViewItem  itm = new ListViewItem(row["id_material"].ToString());
