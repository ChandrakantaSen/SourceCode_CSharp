...
namespace Aplicatie
{
	...
	public class Comenzi : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.label1.Text = "Comanda Distribuire";
            // 
            // label2
            // 
		...
		private void button6_Click(object sender, System.EventArgs e)
		{
			...
			if (valabil)
			{
				...
				/*if (comboBox1.Text.ToString()=="Tevi")
				{
					...
					foreach (DataRow row in ds.Tables[0].Rows)
					{
						valoare=(double.Parse(row["pret_vanzare"].ToString())/20)*double.Parse(textBox8.Text.ToString());
		...
		{
                e.Graphics.DrawString(dePrintat,new Font("Arial",16), new SolidBrush(Color.Black), printDocument1.DefaultPageSettings.Margins.Left,
